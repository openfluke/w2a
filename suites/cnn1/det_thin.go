...
func repeatForwardDet() error {
	...
	if err := suites.RequireDet("cnn1 repeat", max, suites.DetTolFwd); err != nil {
		return err
	}
...
func scmcFwdBwdDet() error {
	...
	if err := suites.RequireDet("cnn1 fwd SC↔MC", dP, suites.DetTolFwd); err != nil {
		return err
	}
	if err := suites.RequireDet("cnn1 bwd SC↔MC", dW, suites.DetTolBwd); err != nil {
		return err
	}
