...
func repeatForwardDet() error {
	...
	if err := suites.RequireDet("lstm repeat", max, suites.DetTolFwd); err != nil {
		return err
	}
...
func scmcFwdBwdDet() error {
	...
	if err := suites.RequireDet("lstm fwd SC↔MC", dP, suites.DetTolFwd); err != nil {
		return err
	}
	if err := suites.RequireDet("lstm bwd SC↔MC", dW, suites.DetTolBwd); err != nil {
		return err
	}
