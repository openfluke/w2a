...
func repeatForwardDet() error {
	...
	if err := suites.RequireDet("rmsnorm repeat", max, suites.DetTolFwd); err != nil {
		return err
	}
...
func scmcFwdBwdDet() error {
	...
	if err := suites.RequireDet("rmsnorm fwd SC↔MC", dP, suites.DetTolFwd); err != nil {
		return err
	}
	if err := suites.RequireDet("rmsnorm bwd SC↔MC", dW, suites.DetTolBwd); err != nil {
		return err
	}
