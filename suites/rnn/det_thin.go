...
func repeatForwardDet() error {
	...
	if err := suites.RequireDet("rnn repeat", max, suites.DetTolFwd); err != nil {
		return err
	}
...
func scmcFwdBwdDet() error {
	...
	if err := suites.RequireDet("rnn fwd SC↔MC", dP, suites.DetTolFwd); err != nil {
		return err
	}
	if err := suites.RequireDet("rnn bwd SC↔MC", dW, suites.DetTolBwd); err != nil {
		return err
	}
